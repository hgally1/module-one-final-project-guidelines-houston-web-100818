...
#             #---------------------------------------------------------------------------------------------# '
#       puts str
#       puts "Welcome to Haunt, the best search tool to find haunted locations!".colorize(:color => :blue, :background => :white)
#       puts
...
#         if GhostHunter.find_by(:id => @@ghost_hunter_id)
...
# def sign_up
#     puts "Welcome to Haunt sign up!".colorize(:green)
#     puts
...
#     current_ghost_hunter = create_ghost_hunter(hunter_name, hunter_location)
#     puts "----------------------------------------------"
#     puts "Thanks for signing up, #{hunter_name.capitalize}. Your User ID is: #{current_ghost_hunter['id']}.".colorize(:color =>:blue, :background => :white)
#     puts
...
#   #** create sign in method (asks for your user id, makes sure that id exists in the ghosthunters table, and returns that number)

#   def main_menu
#     puts
#     puts "Pick your haunt search option! Please enter a number:".colorize(:green)
#     puts "---------------------"
#     puts "1. Search haunts by name".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
#     puts "2. Search haunts by location".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
#     puts "3. Search haunts by the type of paranormal activity".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
#     puts "4. See Saved haunts".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
...
#   def search_by_state
#     puts
#     puts "Please enter the state where you want to ghost hunt".colorize(:green)
#     input = gets.chomp.downcase
#     haunts_by_state = Haunts.where("haunts.state LIKE ?", "%#{input}%")
#     if haunts_by_state.count > 0
#       puts "Here are the haunts in that area:".colorize(:green)
#       puts
#       find_by_state.map {|state| puts "\nName:\n#{haunt[:name]}\nCity:\n#{hash[:city]},\nState:\n#{hash[:state]},\nDescription:\n#{hash[:description]}"
#      puts
#     #   want_to_save = would_you_like_to_save?
#     #   if want_to_save == 'y'
#     #     if Haunt.find_by(:id => @@ghost_hunter_id)
#     #       puts "Please enter the number for the haunt you would like to save: ".colorize(:green)
#     #       user_saved_response = gets.chomp.to_i
#     #       #check to see if user response is valid
#     #       if user_saved_response > 0 && user_saved_response <= haunts_by_state.count
#     #         haunt = haunts_by_state[user_saved_response - 1]
#     #         hunter = @@ghost_hunter_id
#     #         posting = Haunt.find(state["id"])['id']
#     #         if Haunt.find_by(:id => posting)
#     #           save_haunt(hunter,posting)
#     #           haunt_has_been_saved
#     #           main_menu
#     #         else
#     #           invalid_response
#     #           search_by_state
...
#   def search_types
#     puts
#     puts "What kind of paranormal experience are you looking for?".colorize(:green)
#     puts
#     puts "1. Visual Hauntings".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
#     puts "2. Auditory Hauntings".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
#     puts "3. Physical Hauntings".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
#     puts "4. Return to main menu".colorize(:color => :blue, :background => :white)
#     puts "---------------------"
#     search_types_response = gets.chomp.downcase

#     if search_types_response == "1"
#       see_visual_types
